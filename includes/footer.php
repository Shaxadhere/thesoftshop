                        ...
                        <div class="widget widget_text widget_logo">
                            ...
                            <div class="widget_footer">
                                <div class="footer-contact">
                                    ...
                                    <a href="https://api.whatsapp.com/send?phone=923032804856">
                        ...
                        <div class="widget widget_nav_menu">
                            ...
                            <div class="menu_footer widget_footer">
                                <ul class="menu">
                                    ...
                                    <li class="menu-item">
                                        <a href="<?= getHTMLRoot() ?>/category?name=scrunchie">Scrunchies</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="widget widget_nav_menu">
                            ...
                            <div class="menu_footer widget_footer">
                                <ul class="menu">
                                    ...
                                    <li class="menu-item">
                                        <a href="<?= getHTMLRoot() ?>/privacy-policy">Privacy Policy</a>
                                    </li>
                                    <li class="menu-item">
...
<script>
    ...
    if (isset($_REQUEST['added-to-cart'])) {
        echo "$(document).ready(function() {";
        echo "$('#cart-alert-success').fadeTo(2000, 500).slideUp(500, function() {";
        echo "$('#cart-alert-success').slideUp(500);";
        echo "});";
        echo "});";
    }
    ?>
