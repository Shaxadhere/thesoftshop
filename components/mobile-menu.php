...
<div id="nt_menu_canvas" class="nt_fk_canvas nt_sleft dn lazyload">
    ...
    <div class="mb_nav_tabs flex al_center mb_cat_true">
        <div style="flex: 0 0 100%;max-width: 100%;" class="mb_nav_title pr mb_nav_ul flex al_center fl_center active" data-id="#kalles-section-mb_nav_js">
            ...
            <ul id="menu_mb_ul" class="nt_mb_menu">
                ...
                <li class="menu-item menu-item-infos">
                    ...
                    <div class="menu_infos_text">
                        ...
                        <a class="cg" href="https://api.whatsapp.com/send?phone=923032804856">+92 303-280-4856</a><br>
                        <i class="pegk pe-7s-mail fwb mr__10"></i><a class="cg" href="mailto:contact@moreo.pk">contact@moreo.pk</a>
                    </div>
                </li>
            </ul>
        </div>
