                                        ...
                                        <div class="mini_cart_meta">
                                            ...
                                            <div class="cart_meta_price price">
                                                <div class="cart_price">
                                                    <p class="price_range" id="price_ppr">Rs. <?= intval($Product['Price']) * intval($cartItem['productqty']) ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mini_cart_actions">
                                            <div class="quantity pr mr__10 qty__true">
                                                <input type="number" class="input-text qty text tc qty_cart_js" step="1" min="0" max="9999" value="<?= $cartItem['productqty'] ?>">
