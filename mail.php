        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <div>
                        <p style="color: rgb(15, 20, 109); font-weight: bold; font-size: 15px;">DELIVERY DETAILS</p>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                                    <td valign="top" style="color: rgb(15, 20, 109); width: 124.406px; min-width: 100px; font-weight: bold;">Name:</td>
                                    <td>Shahzad Ahmad</td>
                                </tr>
                                <tr>
                                    <td valign="top" style="color: rgb(15, 20, 109); font-weight: bold;">Address:</td>
                                    <td>Main <span zeum4c2="PR_1_0" data-ddnwab="PR_1_0" aria-invalid="spelling" class="LI ng">Waterpump</span>, Ibrahim Haidri, Korangi Creek Karachi, Karachi - Korangi, Sindh</td>
                                </tr>
                                <tr>
                                    <td valign="top" style="color: rgb(15, 20, 109); width: 124.406px; font-weight: bold;">Phone:</td>
                                    <td>3418085619</td>
                                </tr>
                                <tr>
                                    <td valign="top" style="color: rgb(15, 20, 109); width: 124.406px; font-weight: bold;">Email:</td>
                                    <td><a href="mailto:shaxad.here@gmail.com" target="_blank">shaxad.here@gmail.com</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <div>
                        <p style="color: rgb(15, 20, 109); font-weight: bold; font-size: 15px;">ORDER DETAIL</p>
                        <div style="padding-bottom: 10px; margin-top: 10px;">
                            <p style="margin: 0px;">Estimated delivery between 04 July-07 July</p>
                        </div>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                    ...
                    <div>
                        ...
                        <table width="100%" style="width: 691.188px; min-width: 100%;">
                            <tbody>
                                ...
                                <tr>
                                    <td style="color: rgb(83, 83, 83);">Paid via</td>
                    ...
                    <div>
                        <p style="color: rgb(15, 20, 109); font-weight: bold; font-size: 15px;">NEED HELP?</p>
                        <div>
                                                ...
                                                <td align="right">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="200">
                                                        <tbody>
                                                            <tr>
                                                                <td align="right">
                                                                    <p style="margin: 0px;"><a href="http://onelink.to/8b5k4w" target="_blank" style="text-decoration-line: none;"><span style="font-weight: bold; color: rgb(15, 20, 109);">Download</span></a></p><a href="http://onelink.to/8b5k4w" target="_blank" style="text-decoration-line: none;"><span style="font-weight: bold; color: rgb(15, 20, 109);">The App</span></a>
                                                                </td>
                                                                <td align="right" width="65"><a href="http://onelink.to/8b5k4w" target="_blank" style="text-decoration-line: none;"><img src="https://ci3.googleusercontent.com/proxy/2kkhm8nhrv5HCe9egCFbhqfrQgZFNKSB5pjFHrTVwm1qY9M3jgmr-D9KQhx6R8ieDtqsblKCa6cmqmo2ucbB9CTxP2ZgAlAqKlj3Ngs9Ud_9HE8=s0-d-e1-ft#https://img.alicdn.com/tfs/TB1gx4_RVP7gK0jSZFjXXc5aXXa-51-50.png" class="gmail-CToWUd"></a></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
