...
getHeader("New arrivals @".getAppName().".pk Instagram Shop, cute, fancy, good quality and cheap products in pakistan", "includes/header.php");
?>
<!--shop banner-->
                ...
                <ul class="pagination-page page-numbers">
                    <li>
                        ...
                        if ($CurrentPage == 1) {
                            ...
                            echo "<li>";
                            echo "<a class='prev page-numbers' href='" . getHTMLRoot() . "/new-arrivals?$PrevURL'>Prev</a>";
                            echo "</li>";
                        }
                        ...
                        for ($i = 1; $i < $PageNumbers; $i++) {
                            ...
                            if (isset($_REQUEST['page'])) {
                                if ($_REQUEST['page'] == $i) {
                                    echo "<li><a href='" . getHTMLRoot() . "/new-arrivals?$NewUrl' class='page-numbers current'>$i</a></li>";
                                } else {
                                    echo "<li><a href='" . getHTMLRoot() . "/new-arrivals?$NewUrl' class='page-numbers'>$i</a></li>";
                                }
                            } else {
                                if ($i == "1") {
                                    echo "<li><a href='" . getHTMLRoot() . "/new-arrivals?$NewUrl' class='page-numbers current'>$i</a></li>";
                        ...
                        $NextURL = getHTMLRoot() . "/new-arrivals?" . $URL;
                        if (isset($_REQUEST['page'])) {
                        ...
                        if ($CurrentPage == intval($PageNumbers)) {
                            ...
                            echo "<li>";
                            echo "<a class='next page-numbers' href='" . getHTMLRoot() . "/new-arrivals?$NextURL'>Next</a>";
                            echo "</li>";
                        }
                        ?>
                </ul>
