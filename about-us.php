...
<div class="kalles-section page_section_heading">
    <div class="page-head tc pr oh cat_bg_img page_head_">
        ...
        <div class="container pr z_100">
            ...
            <p class="mg__0">a karachi based aesthetic store, a place to get  good quality aesthetic products in affordable range</p>
        </div>
    </div>
</div>
<!--end hero banner-->
...
<div class="kalles-section container mt__20 mb__60">
    <div class="row fl_center cb">
        <div class=" col-12 col-md-12 txtn mt__25">
            ...
            <p class="mg__0">
                <?= getAppName() ?>.pk was built off the idea that of providing you beneficial and aesthetic products. Our journey began in 2020 and we have not stopped curating products since! We are happy to serve you our best quality products by handpicked and crafted, sustainable products. There's a story behind everything we sell - from the artisan who crafts it to the individual who uses it!
            </p>
        </div>
    </div>
</div>
