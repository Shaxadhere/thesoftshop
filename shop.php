...
getHeader("Shop @TheSoftShop.pk Instagram Shop, cute, fancy, good quality and cheap products in pakistan", "includes/header.php");
?>
<!--shop banner-->
...
<div class="container container_cat pop_default cat_default mb__20">
    ...
    <div class="cat_toolbar row fl_center al_center mt__30">
        <div class="cat_filter col op__0 pe_none">
            <a href="#" data-opennt="#kalles-section-nt_filter" data-pos="left" data-remove="true" data-class="popup_filter" data-bg="hide_btn" class="has_icon btn_filter mgr"><i class="iccl fwb iccl-search fwb mr__5"></i>Filter</a>
            <a href="#" data-id="#kalles-section-nt_filter" class="btn_filter js_filter dn mgr"><i class="iccl fwb iccl-search fwb mr__5"></i>Search</a>
        </div>
    ...
    <div class="filter_area_js filter_area lazyload">
        <div id="kalles-section-nt_filter" class="kalles-section nt_ajaxFilter section_nt_filter">
            <div class="h3 mg__0 tu bgb cw visible-sm fs__16 pr">Search <i class="close_pp pegk pe-7s-close fs__40 ml__5"></i>
            </div>
            <div class="cat_shop_wrap">
                <div class="cat_fixcl-scroll">
                    <div class="cat_fixcl-scroll-content css_ntbar">
                        <div class="row wrap_filter">
                            <div class="col-12 col-md-12 widget blockid_title">
                                <h5 class="widget-title">By Title</h5>
                                <div class="loke_scroll mt__10">
                                    <input type="text" class="nt_cat_title search-input" value="" placeholder="Search for product title">
                                    <button type="button" class="button filter_title_btn d-inline-block btn-search-products">Search</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1" data-id="<?= base64_encode($row['PK_ID']) ?>">
                            <div class="product-inner pr">
                                <div class="product-image pr oh lazyload">
                                    ...
                                    <div class="nt_add_w ts__03 pa <?= $_SESSION['WISHLIST'] ?>">
