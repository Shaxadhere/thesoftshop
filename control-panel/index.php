                ...
                <div class="card ht-100p">
                    ...
                    <ul class="list-group list-group-flush tx-13">
                        ...
                        <li class="list-group-item d-flex pd-x-20">
                            <div class="avatar"><img src="<?= getHTMLRoot() ?>/assets/img/img23.jpg" class="rounded-circle" alt=""></div>
                            <div class="pd-l-10">
                        ...
                        <li class="list-group-item d-flex pd-x-20">
                            <div class="avatar"><img src="<?= getHTMLRoot() ?>/assets/img/img16.jpg" class="rounded-circle" alt=""></div>
                            <div class="pd-l-10">
