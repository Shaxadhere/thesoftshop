...
?><div class="col-lg-8 col-xl-7 mg-t-10">
    <div class="card">
        ...
        <div class="card-body pos-relative">
            <div class="row">
                <div class="col-sm-5">
                    <h3 class="tx-normal tx-rubik tx-spacing--2 mg-b-5">PKR <?= $TotalWithdrawls ?></h3>
                ...
                <div class="col-sm-5 mg-t-20 mg-sm-t-0">
                    <h3 class="tx-normal tx-rubik tx-spacing--2 mg-b-5">PKR <?= intval($SalesAmount) - intval($TotalWithdrawls) ?></h3>
