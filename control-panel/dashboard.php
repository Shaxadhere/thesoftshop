    ...
    <div class="row row-xs">
                    ...
                    <div class="pos-absolute t-20 l-20 wd-xl-100p z-index-10">
                        <div class="row">
                            <div class="col-sm-5">
                                ...
                                <p class="mg-b-0 tx-12 tx-color-03">Measure How Fast You’re Growing Monthly Recurring Revenue.
                            ...
                            <div class="col-sm-5 mg-t-20 mg-sm-t-0">
                                ...
                                <p class="mg-b-0 tx-12 tx-color-03">The revenue generated per account on a monthly or yearly basis.
                                    <a href="dashboard-one.html">Learn More</a>
                                </p>
                            </div>
                            <!-- col -->
            ...
            <div class="card ht-lg-100p">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="tx-13 d-flex align-items-center">
                        ...
                        <a href="dashboard-one.html" class="d-flex align-items-center link-03 lh-0">USA
                    ...
                    <div class="d-sm-flex">
                        ...
                        <div class="media mg-t-20 mg-sm-t-0 mg-sm-l-15 mg-md-l-40">
                            ...
                            <div class="media-body">
                                ...
                                <h4 class="tx-20 tx-sm-18 tx-md-24 tx-normal tx-rubik mg-b-0">$234,769<small>.50</small>
                                </h4>
                            </div>
                        </div>
                        <div class="media mg-t-20 mg-sm-t-0 mg-sm-l-15 mg-md-l-40">
                            ...
                            <div class="media-body">
                                ...
                                <h4 class="tx-20 tx-sm-18 tx-md-24 tx-normal tx-rubik mg-b-0">$1,608,469<small>.50</small>
                                </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-dashboard mg-b-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="tx-medium text-right">$28,670.90
                            ...
                            <tr>
                                ...
                                <td class="tx-medium text-right">$26,930.40
            ...
            <div class="card card-body ht-lg-100">
                <div class="media">
                    <span class="tx-color-04">
                        <i data-feather="download" class="wd-60 ht-60"></i>
                    </span>
                    <div class="media-body mg-l-20">
                        <h6 class="mg-b-10">Download your earnings in CSV format.</h6>
                        <p class="tx-color-03 mg-b-0">Open it in a spreadsheet and perform your own calculations, graphing etc. The CSV file contains additional details, such as the buyer location.
                        </p>
                    </div>
                </div>
                <!-- media -->
            ...
            <div class="card ht-100p">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex tx-18">
                        <a href="dashboard-one.html" class="link-03 lh-0">
                            <i class="icon ion-md-refresh"></i>
                        </a>
                        <a href="dashboard-one.html" class="link-03 lh-0 mg-l-10">
                ...
                <ul class="list-group list-group-flush tx-13">
                    ...
                    <li class="list-group-item d-flex pd-sm-x-20">
                        <div class="avatar d-none d-sm-block">
                            <span class="avatar-initial rounded-circle bg-orange op-5">
                    ...
                    <li class="list-group-item d-flex pd-sm-x-20">
                        <div class="avatar d-none d-sm-block">
                            <span class="avatar-initial rounded-circle bg-gray-400">
                ...
                <div class="card-footer text-center tx-13">
                    <a href="dashboard-one.html" class="link-03">View All Transactions
        ...
        <div class="col-md-6 col-xl-4 mg-t-10">
            <div class="card ht-100p">
                    ...
                    <li class="list-group-item d-flex pd-sm-x-20">
                        ...
                        <div class="mg-l-auto d-flex align-self-center">
                            <nav class="nav nav-icon-only">
                                <a href="dashboard-one.html" class="nav-link d-none d-sm-block">
                                ...
                                <a href="dashboard-one.html" class="nav-link d-sm-none">
                ...
                <div class="card-footer text-center tx-13">
                    <a href="dashboard-one.html" class="link-03">View More Customers
                        <i class="icon ion-md-arrow-down mg-l-5"></i>
                    </a>
                </div>
                <!-- card-footer -->
