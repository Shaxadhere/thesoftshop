...
<html lang="en">
  ...
  <body>
    ...
    <header class="navbar navbar-header navbar-header-fixed">
      <a href="page-505.html" id="mainMenuOpen" class="burger-menu"><i data-feather="menu"></i></a>
      ...
      <div id="navbarMenu" class="navbar-menu-wrapper">
        <div class="navbar-menu-header">
          <a href="../../index.html" class="df-logo">dash<span>forge</span></a>
          <a id="mainMenuClose" href="page-505.html"><i data-feather="x"></i></a>
        </div><!-- navbar-menu-header -->
        <ul class="nav navbar-menu">
          <li class="nav-label pd-l-20 pd-lg-l-25 d-lg-none">Main Navigation</li>
          <li class="nav-item with-sub">
            <a href="page-505.html" class="nav-link"><i data-feather="pie-chart"></i> Dashboard</a>
          ...
          <li class="nav-item with-sub">
            <a href="page-505.html" class="nav-link"><i data-feather="package"></i> Apps</a>
            <ul class="navbar-menu-sub">
          ...
          <li class="nav-item with-sub">
            <a href="page-505.html" class="nav-link"><i data-feather="layers"></i> Pages</a>
