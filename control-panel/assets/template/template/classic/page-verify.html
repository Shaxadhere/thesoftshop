...
<html lang="en">
  ...
  <body>
    ...
    <header class="navbar navbar-header navbar-header-fixed">
      <a href="page-verify.html" id="mainMenuOpen" class="burger-menu"><i data-feather="menu"></i></a>
      ...
      <div id="navbarMenu" class="navbar-menu-wrapper">
        <div class="navbar-menu-header">
          <a href="../../index.html" class="df-logo">dash<span>forge</span></a>
          <a id="mainMenuClose" href="page-verify.html"><i data-feather="x"></i></a>
        </div><!-- navbar-menu-header -->
        <ul class="nav navbar-menu">
          <li class="nav-label pd-l-20 pd-lg-l-25 d-lg-none">Main Navigation</li>
          <li class="nav-item with-sub">
            <a href="page-verify.html" class="nav-link"><i data-feather="pie-chart"></i> Dashboard</a>
          ...
          <li class="nav-item with-sub">
            <a href="page-verify.html" class="nav-link"><i data-feather="package"></i> Apps</a>
            <ul class="navbar-menu-sub">
          ...
          <li class="nav-item with-sub">
            <a href="page-verify.html" class="nav-link"><i data-feather="layers"></i> Pages</a>
          ...
          <li class="nav-item"><a href="../../components.html" class="nav-link"><i data-feather="box"></i> Components</a></li>
      ...
      <div class="container ht-100p">
        <div class="ht-100p d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="tx-13 tx-lg-14 mg-b-40">
            <a href="page-verify.html" class="btn btn-brand-02 d-inline-flex align-items-center">Resend Verification</a>
            <a href="page-verify.html" class="btn btn-white d-inline-flex align-items-center mg-l-5">Contact Support</a>
          </div>
