      ...
      <div id="navbarMenu" class="navbar-menu-wrapper">
        ...
        <ul class="nav navbar-menu">
          ...
          <li class="nav-item with-sub">
            <a href="page-signin.html" class="nav-link"><i data-feather="pie-chart"></i> Dashboard</a>
          ...
          <li class="nav-item with-sub">
            <a href="page-signin.html" class="nav-link"><i data-feather="package"></i> Apps</a>
            <ul class="navbar-menu-sub">
          ...
          <li class="nav-item with-sub">
            <a href="page-signin.html" class="nav-link"><i data-feather="layers"></i> Pages</a>
            ...
            <div class="wd-100p">
              ...
              <div class="form-group">
                <div class="d-flex justify-content-between mg-b-5">
                  ...
                  <a href="page-signin.html" class="tx-13">Forgot password?</a>
                </div>
